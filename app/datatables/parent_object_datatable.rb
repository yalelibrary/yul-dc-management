...
class ParentObjectDatatable < ApplicationDatatable
  ...
  def get_raw_records # rubocop:disable Naming/AccessorMethodName
    ...
    ParentObject.accessible_by(@current_ability, :read).joins(:authoritative_metadata_source, :admin_set, 'LEFT OUTER JOIN permission_sets ON parent_object.permission_set_id = permission_set.label').where("visibility != 'Redirect'")
  end
end
