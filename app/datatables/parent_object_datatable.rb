...
class ParentObjectDatatable < ApplicationDatatable
  ...
  def view_columns
    ...
    @view_columns ||= {
      ...
      authoritative_source: { source: "MetadataSource.metadata_cloud_name", cond: :string_eq, searchable: true, options: MetadataSource.all_metadata_cloud_names - %w[ils sierra], orderable: true },
