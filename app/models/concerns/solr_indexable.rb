  ...
  def to_solr(json_to_index = nil)
    if redirect_to.present?
      ...
      return nil if json_to_index.blank? || !manifest_completed?
      {
        ...
        acquisitionSource_tesim: json_to_index["acquisitionSource"],
        almaHolding_ssi: json_to_index["holdingId"],
        almaItem_ssi: json_to_index["pid"],
        ...
        bindingInfo_tesim: json_to_index["bindingInfo"],
        ...
        copyDescription_tesim: json_to_index["copyDescription"],
