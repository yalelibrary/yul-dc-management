...
class Preservica::Bitstream
  ...
  def download_to_file(file_name)
    ...
    raise StandardError, "The checksum for this object is different than the checksum that DCS expected. Please ensure your image folder in Preservica has SHA-512 fixity checksums." unless data_sha512.casecmp?(sha512_checksum)
