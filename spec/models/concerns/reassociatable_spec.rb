...
RSpec.describe Reassociatable, type: :model, prep_metadata_sources: true, prep_admin_sets: true do
  let(:reassociatable) { BatchProcess.new }
  let(:parent_object) { FactoryBot.create(:parent_object, oid: '222', authoritative_metadata_source: MetadataSource.first, admin_set: AdminSet.first) }
