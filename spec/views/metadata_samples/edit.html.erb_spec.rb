...
RSpec.describe "metadata_samples/edit", type: :view do
  before do
  ...
  it "renders the edit metadata_sample form" do
    render

    assert_select "form[action=?][method=?]", metadata_sample_path(@metadata_sample), "post" do
