...
RSpec.describe ChildObjectDatatable, type: :datatable, prep_metadata_sources: true, prep_admin_sets: true do
  ...
  it 'renders a complete data table' do
    ...
    FactoryBot.create(:child_object, parent_object: parent_object, preservica_content_object_uri: '/content_object_uri', preservica_generation_uri: '/generation_uri', preservica_bitstream_uri: '/bitstream_uri')
