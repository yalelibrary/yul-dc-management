...
RSpec.describe ParentObjectDatatable, type: :datatable, prep_metadata_sources: true, prep_admin_sets: true do
  ...
  it 'can handle a parent object' do
    ...
    po = FactoryBot.create(:parent_object, oid: oid, admin_set: admin_set, extent_of_full_text: 'None', project_identifier: '67', digital_object_source: "Preservica", preservica_uri: "/preservica_uri")
