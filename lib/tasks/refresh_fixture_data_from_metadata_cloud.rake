...
namespace :yale do
  desc "METADATA_SOURCE=aspace|ils|ladybird rake yale:refresh_fixture_data Refreshes fixture data from metadata cloud"
  task refresh_fixture_data: :environment do
    ...
    puts "#{metadata_source} data refreshed from metadata cloud"
  end
end
